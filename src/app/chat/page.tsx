...
export default function ChatPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-4 p-4 md:p-6 lg:flex-row lg:items-start">
      <aside className="w-full shrink-0 lg:sticky lg:top-6 lg:max-h-[calc(100vh-3rem)] lg:w-80">
        <Card className="glass-surface flex max-h-[calc(100vh-2rem)] flex-col overflow-hidden lg:max-h-[calc(100vh-3rem)]">
