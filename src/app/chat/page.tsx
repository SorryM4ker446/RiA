  ...
  function readChatPreferences(chatId: string): ChatScopedPreferences | null {
    ...
    try {
      ...
      const selectedManualTool: ManualToolSelection =
        parsed.selectedManualTool === "searchKnowledge" || parsed.selectedManualTool === "createTask"
